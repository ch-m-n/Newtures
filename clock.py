...
def con():
    ...
    t1 = threading.Thread(target=bot.run(pair=list.trx['symbol'], 
                                                q=list.trx['quote'], 
                                                b=list.trx['base'], 
                                                step=list.trx['step'],
    ...
    t2 = threading.Thread(target=bot.run(pair=list.bat['symbol'], 
                                                q=list.bat['quote'], 
                                                b=list.bat['base'], 
                                                step=list.bat['step'],
    ...
    t3 = threading.Thread(target=bot.run(pair=list.xlm['symbol'], 
                                                q=list.xlm['quote'], 
                                                b=list.xlm['base'], 
                                                step=list.xlm['step'],
    ...
    t4 = threading.Thread(target=bot.run(pair=list.iota['symbol'], 
                                                q=list.iota['quote'], 
                                                b=list.iota['base'], 
                                                step=list.iota['step'],
