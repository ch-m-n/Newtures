...
class start:
    ...
    def strategy(self):
        ...
        while ol < bl:
            quou1.changeSideBull()
            if quou1.marketSide == 'BULL' and quou1.bullsidetimes == 0:
                """"""
                try:
                    closeSellOrder()
                except:
                    pass
                quou1.changeBullTimes1()
                quou1.changeBearTimes0()
                print('BULLISH')
                break
            if quou1.marketSide == 'BULL' and quou1.bullsidetimes == 1:
                break 
            
        while ol > bl:
            quou1.changeSideBear()
            if quou1.marketSide == 'BEAR' and quou1.bearsidetimes == 0:
                """"""
                try:
                    closeBuyOrder()
                except:
                    pass
                quou1.changeBearTimes1()
                quou1.changeBullTimes0()
                print('BEARISH')
                break
            if quou1.marketSide == 'BEAR' and quou1.bearsidetimes == 1:
                break
